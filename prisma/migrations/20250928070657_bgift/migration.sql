...
-- CreateIndex
CREATE UNIQUE INDEX "friend_requests_requesterId_receiverId_key" ON "public"."friend_requests"("requesterId", "receiverId");
...
-- AddForeignKey
ALTER TABLE "public"."friend_requests" ADD CONSTRAINT "friend_requests_requesterId_fkey" FOREIGN KEY ("requesterId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
